      ...
      <div className="w-full min-h-[140vh] bg-white relative overflow-hidden flex flex-col pb-20">
        ...
        <div className="text-center pt-16 z-10 items-center">
            ...
            ">
              ...
              <span className="bg-gradient-to-r text-emerald-400 font-extrabold tracking-tighter font-weight-semibold">
                Blackboard. 
              </span>{" "}
              ...
              >
                ...
                <div
                  className="
                    ...
                    w-[120%]
                    h-[120%]
                    bg-gradient-to-br from-[#081b33] via-[#0d5c63] to-[#94c917] 
                    overflow-hidden
                  "
                  style={{
  ...
  <div className='relative w-full max-w-7xl h-[320px]'>
    ...
    <section
        ...
        <div className="sticky top-0 h-screen">
            ...
            <div className="grid grid-cols-12 h-full gap-12">
                ...
                <div className="col-span-8 flex items-center mt-20 p-4">
                    <motion.div
                        key={activeStep}
                        initial={{
                            opacity: 0,
